...
import Styles from './MyBreakdownStyle';

// create a component
export default class MyBreakdown extends Component {
  constructor() {
    super();
      ...
      FlatListItems: [
        {
          ...
          description:
            'Hi, we are happy to inform you that you have great sales last month...',
          time: '10 Min ago',
        },
        {
          name: 'You have 2x more point alloted!',
